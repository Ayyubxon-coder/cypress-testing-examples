...
describe('Input obstacles', () => {
  ...
  it('should find and control a checkbox input', () => {
    ...
    cy.get('[data-test="checkbox-sardines"]');
  ...
  it('should find and control a date input', () => {
    const beautifulDate = '2021-12-17';
    cy.get('[data-test="date-input"]').invoke('val', beautifulDate);
    cy.get('[data-test="date-result"]').contains(beautifulDate)
  });

  it('should find and control a range input', () => {
    cy.get('[data-test="range-input"]').invoke('val', 6).trigger();
